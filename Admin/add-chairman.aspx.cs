...
public partial class Admin_add_chairman : System.Web.UI.Page
{
    ...
    {
        st = "insert into principal (Name,Email,Password)values('" + txt_name.Text + "','" + txt_emailid.Text + "','" + txt_password.Text + "')";
        ...
        if (x > 0)
        {
            ...
            fill_repeater();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "", "showalert('success','Principal Added successfully.');", true);
        }
        else
        {
