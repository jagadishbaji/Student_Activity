<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage-student.aspx.cs" Inherits="Principal_manage_student" %>
                                        ...
                                        <table class="table table-hover table-bordered">
                                            ...
                                            <asp:Repeater ID="Repeater1" runat="server">
                                                <ItemTemplate>
                                                    ...
                                                    <td><%# Eval("dept") %></td>
                                                        <td>
                                                            <asp:LinkButton ID="lnk_delete" ToolTip="Delete" CommandArgument='<%# Eval("student_id") %>' OnClick="lnk_delete_Click" runat="server"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
