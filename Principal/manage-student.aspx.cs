...
public partial class Principal_manage_student : System.Web.UI.Page
{
    string st = "";
    mydb db = new mydb();
    SqlCommand cmd;
    ...
    protected void lnk_delete_Click(object sender, EventArgs e)
    {
        ...
        st = "delete  from period1 where student_id=" + lnk.CommandArgument;
        db.ExeQuery(st);
        st = "delete  from period2 where student_id=" + lnk.CommandArgument;
        db.ExeQuery(st);
        st = "delete  from period3 where student_id=" + lnk.CommandArgument;
        db.ExeQuery(st);
        st = "delete  from period4 where student_id=" + lnk.CommandArgument;
        db.ExeQuery(st);
        st = "delete  from student where student_id=" + lnk.CommandArgument;
        db.ExeQuery(st);
