<%@ Page Language="C#" AutoEventWireup="true" CodeFile="placement-manage.aspx.cs" Inherits="Principal_placement_manage" %>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>Placement Cell
                        ...
                        <small>Add Placement-Managers</small>
                    </h1>
                    <ol class="breadcrumb">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-bordered">
                                            ...
                                            <asp:Repeater ID="Repeater1" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                         <td><%# Eval("company_id") %></td>
                                                        <td><%# Eval("name") %></td>
                                                        <td><%# Eval("email") %></td>
                                                        <td><%# Eval("address") %></td>
                                                      
                                                        <td>
                                                            <asp:LinkButton ID="lnk_delete" ToolTip="Delete" CommandArgument='<%# Eval("company_id") %>' OnClick="lnk_delete_Click" runat="server"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                            </asp:Repeater>
