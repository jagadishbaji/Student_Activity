<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view-students.aspx.cs" Inherits="Principal_view_students" %>



<%@ Register Src="~/Principal/header.ascx" TagPrefix="uc1" TagName="header" %>
<%@ Register Src="~/Principal/sidemenu.ascx" TagPrefix="uc1" TagName="sidemenu" %>
