<%@ Page Language="C#" AutoEventWireup="true" CodeFile="apply-placements.aspx.cs" Inherits="student_apply_placements" %>
                            ...
                            <div >
                                ...
                                <div >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Skills</label>
                                        <asp:TextBox ID="txt_skills" CssClass="form-control" placeholder="Add-Skills" runat="server"></asp:TextBox>
                                        <asp:RequiredFieldValidator ValidationGroup="g1" ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Skills" ForeColor="Red" Display="Dynamic" ControlToValidate="txt_skills"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ValidationGroup="g1" ID="RegularExpressionValidator3" Display="Dynamic" runat="server" ErrorMessage="Enter skills" ForeColor="Red" ControlToValidate="txt_skills" ValidationExpression="[a-z A-Z 0-9]+"></asp:RegularExpressionValidator>
                                    </div>
